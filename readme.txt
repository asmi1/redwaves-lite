...
== Changelog ==
= 2.1.5 - January 25 2017 =
* Fixed 404 errors.
* FontAwesome updated to version 4.7.0.
= 2.1.3 - August 05 2016 =
* Fixed Google's Adsense ads have a Yellow background (Topic: https://forum.themient.com/viewtopic.php?f=11&t=127).
= 2.1.2 - July 13 2016 =
* Fixed "Sticky Navigation menu" option not working.
= 2.1.1 - July 09 2016 =
* Fixed mobile menu's children items not being clickable.
= 2.1.0 - July 06 2016 =
* Improved Mobile menu.
* Added Mobile menu "Side" and "Style" options, check Customize > General Settings.
* Bug fixes.
* Minor style adjustments.
= 2.0.7 - February 05 2016 =
* Added Upgrade link in the Customizer.
